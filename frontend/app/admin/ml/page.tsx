    ...
    <AdminShell
      ...
      headerActions={
        <div className="rounded-sm border border-slate-200 bg-[#f8f9fc] px-4 py-3 text-sm text-slate-600">
          Mode kerja: <span className="font-semibold text-slate-900">Manual dan Impor CSV</span>
        </div>
      }
    >
      <div className="rounded-sm border border-blue-100 bg-blue-50 px-4 py-4 text-sm leading-6 text-blue-900">
        Halaman ini memusatkan alur kerja pembelajaran mesin admin agar proses
        prediksi bulanan dan pembaruan dataset tidak bercampur dengan ringkasan
        monitoring.
      </div>
      <AdminMlPanel />
    </AdminShell>
